...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames=cms.untracked.vstring(
                                # "/store/hidata/HIRun2018A/ZeroBias/AOD/PromptReco-v2/000/326/900/00000/70B6F68E-6262-E245-8F1D-9B93DA25EE44.root"
                                "file:/eos/cms/store/group/phys_diffraction/lbyl_2018/HIZeroBias/reco_20_04_2026/ZeroBias/aod_zeroBias_20_04_2026/260420_065136/0000/HIZeroBias_test_100.root"
                            ),
                            )
...
process.MessageLogger.suppressWarning = cms.untracked.vstring('hltanalysis')
...
process.hltanalysis.triggerResults = cms.InputTag("TriggerResults", "", "HLT")
# process.hltanalysis.hltProcessName = "HLT"
process.hltanalysis.l1GtReadoutRecord = cms.InputTag("")
# process.hltanalysis.doPrescale = False
...
process.ggHiNtuplizer.doPixelTracks = False
process.ggHiNtuplizer.doTrackerHits = False
