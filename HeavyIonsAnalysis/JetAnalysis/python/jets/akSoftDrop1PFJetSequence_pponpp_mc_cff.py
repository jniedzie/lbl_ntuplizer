...
akSoftDrop1PFpatJetsWithBtagging = patJets.clone(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("akSoftDrop1PFImpactParameterTagInfos"),cms.InputTag("akSoftDrop1PFSecondaryVertexTagInfos")),
